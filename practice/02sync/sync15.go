...
/*
   subject: (from sync13:close channel broadcast) use flag again=OK
*/
type readOp struct {
	key  int
	resp chan int
...
func main() {
	...
	stopw, stopr, stopm = true, true, true
...
// Compilation started at Sat Sep 25 13:43:04
//  
// go run sync15.go 
// ..................,,....................,writes=writes2
// reads=reads2
// ,main timeout 2021-09-25 13:43:07.477622 +0900 JST m=+2.005433747
...
// 1 write[0]:51 response true
// 0 write[0]:57 response true
...
// 1 read[0] = 32
// 0 read[3] = 18
// 1 write[0]:59 response true
// 0 write[0]:83 response true
// 0 read[0] = 83
// 1 read[4] = 97
// 1 read[2] = 58
// 0 read[0] = 83
...
// read func exit <-------------rrr
// wgr.Wait() exit
// main timeout 2021-09-25 13:43:19.426211 +0900 JST m=+13.953936221
// func main end <=============
// wgm.Wait() exit
// readOps: 116
// writeOps: 19
...
// writeOps: 19
//  
// Compilation finished at Sat Sep 25 13:43:25
