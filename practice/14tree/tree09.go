...
/*
   subject : A Tour of Go Exercise: Equivalent Binary Trees.  deleting slice element(no.2)
*/
//type Tree struct {
// 	Left  *Tree
// 	Value int
...
func newTree(from, to int) *tree.Tree {
	...
	for i:=0; i<n; i++ {
		...
		//islice[idx] = islice[len(islice) - 1]
		//islice = islice[:len(islice) - 1]
		//leng = len(islice)
...
// Compilation started at Fri Oct 22 00:01:12
//  
// go run tree09.go
...
// false
//  
// Compilation finished at Fri Oct 22 00:01:13
