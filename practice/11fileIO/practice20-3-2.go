...
/*
   subject : fileI/O bufio.NewScanner.Scan/Bytes write.Write/WriteByte: DOS->unix, keep last line without LF(add LF)
*/ 
...
func main() {
	...
	err := rwlines("dat/combo.txt", "dat/combo-3-2.txt");
	if err != nil {
		fmt.Println(err)
	}
}
